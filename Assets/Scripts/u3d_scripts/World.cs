...
public class World : MonoBehaviour
{
    ...
    public void onAvatarEnterWorld(UInt64 rndUUID, Int32 eid, KBEngine.AvatarViewModel avatar)
    {
        if (!avatar.isPlayer())
        {
            return;
    ...
    public void createPlayer()
    {
        ...
        KBEngine.AvatarViewModel avatar = (KBEngine.AvatarViewModel)KBEngineApp.app.player();
        if (avatar == null)
        {
        ...
        player = Instantiate(avatarPerfab, new Vector3(avatar.position.x, avatar.position.z, layer), Quaternion.Euler(new Vector3(avatar.direction.y, avatar.direction.z, avatar.direction.x))) as UnityEngine.GameObject;
        avatar.renderObj = player;
        var avatarView = player.GetComponent<AvatarView>();
        avatarView.BindViewModel(avatar);
        avatarView.isAvatar = true;
        avatarView.isPlayer = true;
    ...
    public void onEnterWorld(KBEngine.Entity entity)
    {
        ...
        else
        {
            ...
            {
                ((UnityEngine.GameObject)entity.renderObj).GetComponent<AvatarView>().isAvatar = true;
            }
        }
    }
    ...
    public void updatePosition(KBEngine.Entity entity)
    {
        ...
        GameObject go = ((UnityEngine.GameObject)entity.renderObj);
        go.transform.position = new Vector3(entity.position.x, entity.position.z, go.transform.position.z);
    }
    ...
    public void set_direction(KBEngine.Entity entity)
    {
        ...
        ((UnityEngine.GameObject)entity.renderObj).transform.eulerAngles = new Vector3(entity.direction.y, entity.direction.z, entity.direction.x);
    }
