...
namespace KBEngine
{
	...
	public abstract class RoomBase : uFrame.MVVM.ViewModels.ViewModel
	{
		...
		public RoomBase(uFrame.Kernel.IEventAggregator aggregator) :base(aggregator) 
		{
		}
		...
		{
			ScriptModule sm = EntityDef.moduledefs["RoomViewModel"];
	...
	public partial class RoomViewModel: RoomBase { public RoomViewModel(uFrame.Kernel.IEventAggregator aggregator):base(aggregator) {  } }
}