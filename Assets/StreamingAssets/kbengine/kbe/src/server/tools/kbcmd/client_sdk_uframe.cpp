...
//-------------------------------------------------------------------------------------
ClientSDKUFrame::ClientSDKUFrame():
	ClientSDK(),
	initBody_()
{
}
...
//-------------------------------------------------------------------------------------
std::string ClientSDKUFrame::typeToType(const std::string& type)
{
	if (type == "INT8")
	{
		return "SByte";
...
//-------------------------------------------------------------------------------------
void ClientSDKUFrame::onCreateTypeFileName()
{
	sourcefileName_ = "KBETypes.cs";
}

//-------------------------------------------------------------------------------------
void ClientSDKUFrame::onCreateEntityModuleFileName(const std::string& moduleName)
{
	sourcefileName_ = "/../../Scripts/uFrame_kbe/KBEngineSystem/ViewModels.designer/" + std::string(moduleName) + "ViewModel.designer.cs";
}

//-------------------------------------------------------------------------------------
void ClientSDKUFrame::onCreateServerErrorDescrsModuleFileName()
{
	sourcefileName_ = "ServerErrorDescrs.cs";
}

//-------------------------------------------------------------------------------------
void ClientSDKUFrame::onCreateEngineMessagesModuleFileName()
{
	sourcefileName_ = "Messages.cs";
}

//-------------------------------------------------------------------------------------
void ClientSDKUFrame::onCreateDefsCustomTypesModuleFileName()
{
	sourcefileName_ = "CustomDataTypes.cs";
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeServerErrorDescrsModuleBegin()
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeServerErrorDescrsModuleErrDescr(int errorID, const std::string& errname, const std::string& errdescr)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeServerErrorDescrsModuleEnd()
{
	sourcefileBody_ += "\n\t\t}\n\n";
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEngineMessagesModuleBegin()
{
	initBody_ = "";
	sourcefileBody_ = headerBody;
	strutil::kbe_replace(sourcefileBody_, "#REPLACE#", "");
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEngineMessagesModuleMessage(Network::ExposedMessageInfo& messageInfos, COMPONENT_TYPE componentType)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEngineMessagesModuleEnd()
{
	sourcefileBody_ += fmt::format("\tpublic class {}\n\t{{\n", "Messages");
...
//-------------------------------------------------------------------------------------
void ClientSDKUFrame::onCreateEntityDefsModuleFileName()
{
	sourcefileName_ = "EntityDef.cs";
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityDefsModuleBegin()
{
	initBody_ = "";
	sourcefileBody_ = headerBody;
	strutil::kbe_replace(sourcefileBody_, "#REPLACE#", "");
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityDefsModuleEnd()
{
	sourcefileBody_ += "\t}\n\n\n}";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityDefsModuleInitScriptBegin()
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityDefsModuleInitScriptEnd()
{
	sourcefileBody_ += "\t\t}\n\n";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityDefsModuleInitDefTypesBegin()
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityDefsModuleInitDefTypesEnd()
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityDefsModuleInitDefType(const DataType* pDataType)
{
...
//-------------------------------------------------------------------------------------
void ClientSDKUFrame::onEntityCallModuleFileName(const std::string& moduleName)
{
	sourcefileName_ = std::string("EntityCall") + moduleName + moduleSuffix + ".cs";
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityCallBegin(ScriptDefModule* pScriptDefModule)
{
	sourcefileBody_ = headerBody;
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityCallEnd(ScriptDefModule* pScriptDefModule)
{
	sourcefileBody_ += fmt::format("\t}}\n");
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityCallMethodBegin(ScriptDefModule* pScriptDefModule, MethodDescription* pMethodDescription, const char* fillString1, const char* fillString2, COMPONENT_TYPE componentType)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityCallMethodEnd(ScriptDefModule* pScriptDefModule, MethodDescription* pMethodDescription)
{
	sourcefileBody_ += fmt::format("\t\t}}\n\n");
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeBaseEntityCallBegin(ScriptDefModule* pScriptDefModule)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeBaseEntityCallEnd(ScriptDefModule* pScriptDefModule)
{
	sourcefileBody_ += fmt::format("\t}}\n");
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeCellEntityCallBegin(ScriptDefModule* pScriptDefModule)
{
	std::string newModuleName;
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeCellEntityCallEnd(ScriptDefModule* pScriptDefModule)
{
	sourcefileBody_ += fmt::format("\t}}\n");
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeCustomDataTypesBegin()
{
	initBody_ = "";
	sourcefileBody_ = headerBody;
	strutil::kbe_replace(sourcefileBody_, "#REPLACE#", "");
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeCustomDataTypesEnd()
{
	sourcefileBody_ += "\n}";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::createArrayChildClass(DataType* pRootDataType, DataType* pDataType, const std::string& className, const std::string& tabs, int numLayer)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeCustomDataType(const DataType* pDataType)
{
	uint16 typeID = datatype2id(pDataType->getName());
	if (typeID == 0 || strcmp(pDataType->getName(), "FIXED_DICT") == 0 || strcmp(pDataType->getName(), "ARRAY") == 0)
	{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityDefsModuleInitScript_ScriptModule(ScriptDefModule* pScriptDefModule)
{
	sourcefileBody_ += fmt::format("\t\t\tScriptModule p{}Module = new ScriptModule(\"{}ViewModel\");\n", pScriptDefModule->getName(), pScriptDefModule->getName());
	sourcefileBody_ += fmt::format("\t\t\tEntityDef.moduledefs[\"{}ViewModel\"] = p{}Module;\n", pScriptDefModule->getName(), pScriptDefModule->getName());
	sourcefileBody_ += fmt::format("\t\t\tEntityDef.idmoduledefs[{}] = p{}Module;\n\n", pScriptDefModule->getUType(), pScriptDefModule->getName());
	return true;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityDefsModuleInitScript_MethodDescr(ScriptDefModule* pScriptDefModule, MethodDescription* pDescr, COMPONENT_TYPE componentType)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityDefsModuleInitScript_PropertyDescr(ScriptDefModule* pScriptDefModule, PropertyDescription* pDescr)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypesBegin()
{
	sourcefileBody_ = headerBody;
	strutil::kbe_replace(sourcefileBody_, "#REPLACE#", "");
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypesEnd()
{
	sourcefileBody_ += "\n}";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeBegin(std::string typeName, FixedDictType* pDataType)
{
	sourcefileBody_ += fmt::format("\tpublic class {}\n\t{{\n", typeName);
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeEnd(std::string typeName, FixedDictType* pDataType)
{
	sourcefileBody_ += "\n\t}\n\n";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeBegin(std::string typeName, FixedArrayType* pDataType, const std::string& parentClass)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeEnd(std::string typeName, FixedArrayType* pDataType)
{
	sourcefileBody_ += "\n\t}\n\n";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeBegin(std::string typeName, DataType* pDataType)
{
	sourcefileBody_ += fmt::format("\tpublic struct {}\n\t{{\n", typeName);
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeEnd(std::string typeName, DataType* pDataType)
{
	sourcefileBody_ += "\t}\n\n";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_AliasName(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_INT8(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_INT16(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_INT32(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_INT64(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_UINT8(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_UINT16(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_UINT32(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_UINT64(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_FLOAT(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_DOUBLE(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_STRING(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_UNICODE(const std::string& itemName, const std::string& childItemName)
{
	sourcefileBody_ += fmt::format("\t\tpublic string {} = \"\";\n", itemName);
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_PYTHON(const std::string& itemName, const std::string& childItemName)
{
	return writeTypeItemType_BLOB(itemName, childItemName);
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_PY_DICT(const std::string& itemName, const std::string& childItemName)
{
	return writeTypeItemType_BLOB(itemName, childItemName);
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_PY_TUPLE(const std::string& itemName, const std::string& childItemName)
{
	return writeTypeItemType_BLOB(itemName, childItemName);
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_PY_LIST(const std::string& itemName, const std::string& childItemName)
{
	return writeTypeItemType_BLOB(itemName, childItemName);
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_BLOB(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_ARRAY(const std::string& itemName, const std::string& childItemName, DataType* pDataType)
{
	std::string typeStr;
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_FIXED_DICT(const std::string& itemName, const std::string& childItemName, DataType* pDataType)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_VECTOR2(const std::string& itemName, const std::string& childItemName)
{
#ifdef CLIENT_NO_FLOAT
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_VECTOR3(const std::string& itemName, const std::string& childItemName)
{
#ifdef CLIENT_NO_FLOAT
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_VECTOR4(const std::string& itemName, const std::string& childItemName)
{
#ifdef CLIENT_NO_FLOAT
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeTypeItemType_ENTITYCALL(const std::string& itemName, const std::string& childItemName)
{
	sourcefileBody_ += fmt::format("\t\tpublic byte[] {} = new byte[0];\n", itemName);
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityModule(ScriptDefModule* pEntityScriptDefModule)
{
	DEBUG_MSG(fmt::format("ClientSDK::writeEntityModule(): {}/{}\n",
		currSourcePath_, pEntityScriptDefModule->getName()));


	std::string uFrame_kbe = currSourcePath_ + "/../../Scripts/uFrame_kbe";
	CreatDir((uFrame_kbe).c_str());
	std::string KBEngineDir = uFrame_kbe + "/KBEngineSystem";
	CreatDir((KBEngineDir).c_str());
	std::string Controllers_designer = (KBEngineDir + "/Controllers.designer");
	CreatDir(Controllers_designer.c_str());
	std::string ViewModels_designer = (KBEngineDir + "/ViewModels.designer");
	CreatDir(ViewModels_designer.c_str());
	std::string Views_designer = (KBEngineDir + "/Views.designer");
	CreatDir(Views_designer.c_str());
	std::string Controllers = (KBEngineDir + "/Controllers");
	CreatDir(Controllers.c_str());
	std::string ViewModels = (KBEngineDir + "/ViewModels");
	CreatDir(ViewModels.c_str());
	std::string Views = (KBEngineDir + "/Views");
	CreatDir(Views.c_str());

	
	//int iRet = -1;
	//char* pszDir = NULL;
	//pszDir = strdup((Controllers + "/" + std::string(pEntityScriptDefModule->getName()) + "Controller.cs").c_str());
	//iRet = KBE_ACCESS(pszDir, 0);
	if (_access((Controllers + "/" + std::string(pEntityScriptDefModule->getName()) + "Controller.cs").c_str(), 0) == -1)
	{
		CreatDir(Controllers.c_str());
		sourcefileName_ = sourcefileBody_ = "";
		headerfileName_ = headerfileBody_ = "";
		sourcefileName_ = "/../../Scripts/uFrame_kbe/KBEngineSystem/Controllers/" + std::string(pEntityScriptDefModule->getName()) + "Controller.cs";
		if (!writeEntityModuleControllerBegin(pEntityScriptDefModule))
			return false;
		if (!writeEntityModuleEnd(pEntityScriptDefModule))
			return false;
		saveFile();
	}
	if (_access((Views + "/" + std::string(pEntityScriptDefModule->getName()) + "View.cs").c_str(), 0) == -1)
	{
		CreatDir(Views.c_str());
		sourcefileName_ = sourcefileBody_ = "";
		headerfileName_ = headerfileBody_ = "";
		sourcefileName_ = "/../../Scripts/uFrame_kbe/KBEngineSystem/Views/" + std::string(pEntityScriptDefModule->getName()) + "View.cs";
		if (!writeEntityModuleViewBegin(pEntityScriptDefModule))
			return false;
		if (!writeEntityModuleEnd(pEntityScriptDefModule))
			return false;
		saveFile();
	}
	if (_access((ViewModels + "/" + std::string(pEntityScriptDefModule->getName()) + "ViewModel.cs").c_str(), 0) == -1)
	{
		CreatDir(ViewModels.c_str());
		sourcefileName_ = sourcefileBody_ = "";
		headerfileName_ = headerfileBody_ = "";
		sourcefileName_ = "/../../Scripts/uFrame_kbe/KBEngineSystem/ViewModels/" + std::string(pEntityScriptDefModule->getName()) + "ViewModel.cs";
		if (!writeEntityModuleModelBegin(pEntityScriptDefModule))
			return false;
		if (!writeEntityModuleEnd(pEntityScriptDefModule))
			return false;
		saveFile();
	...
	if (!writeEntityProcessMessagesMethod(pEntityScriptDefModule))
		return false;
	if (!writeEntityModuleViewModelEnd(pEntityScriptDefModule))
		return false;
	saveFile();
	...
	sourcefileName_ = sourcefileBody_ = "";
	headerfileName_ = headerfileBody_ = "";
	sourcefileName_ = "/../../Scripts/uFrame_kbe/KBEngineSystem/Controllers.designer/" + std::string(pEntityScriptDefModule->getName()) + "Controller.designer.cs";
	if (!writeEntityModuleControllerBaseBegin(pEntityScriptDefModule))
		return false;
	if (!writeEntityModuleEnd(pEntityScriptDefModule))
		return false;
	saveFile();
	...
	sourcefileName_ = sourcefileBody_ = "";
	headerfileName_ = headerfileBody_ = "";
	sourcefileName_ = "/../../Scripts/uFrame_kbe/KBEngineSystem/Views.designer/" + std::string(pEntityScriptDefModule->getName()) + "ViewBase.designer.cs";
	if (!writeEntityModuleViewBaseBegin(pEntityScriptDefModule))
		return false;
	if (!writeEntityModuleEnd(pEntityScriptDefModule))
		return false;
	return saveFile();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityModuleControllerBegin(ScriptDefModule* pEntityScriptDefModule)
{
	std::string newModuleName = fmt::format("{}{}", pEntityScriptDefModule->getName(), "Controller");
	sourcefileBody_ += "namespace KBEngine\n{\n";
	sourcefileBody_ += "\tusing UnityEngine;\n";
	sourcefileBody_ += "\tusing System;\n";
	sourcefileBody_ += "\tusing System.Collections;\n";
	sourcefileBody_ += "\tusing System.Collections.Generic;\n";
	sourcefileBody_ += "\tusing uFrame.IOC;\n";
	sourcefileBody_ += "\tusing uFrame.Kernel;\n";
	sourcefileBody_ += "\tusing uFrame.Kernel.Serialization;\n";
	sourcefileBody_ += "\tusing uFrame.MVVM;\n";
	sourcefileBody_ += "\tusing uFrame.MVVM.Bindings;\n";
	sourcefileBody_ += "\tusing uFrame.MVVM.ViewModels;\n";
	sourcefileBody_ += "\tusing UniRx;\n\n";
	if (!pEntityScriptDefModule->isComponentModule())
	{
		sourcefileBody_ += fmt::format("\tpublic class {} : {}Base\n\t{{\n", newModuleName, newModuleName);
		sourcefileBody_ += fmt::format("\t\tpublic override void Initialize{}({}ViewModel viewModel) {{\n", pEntityScriptDefModule->getName(), pEntityScriptDefModule->getName());
		sourcefileBody_ += fmt::format("\t\t\tbase.Initialize{}(viewModel); }}\n", pEntityScriptDefModule->getName());
	}
	return true;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityModuleControllerBaseBegin(ScriptDefModule* pEntityScriptDefModule)
{
	std::string newModuleName = fmt::format("{}{}", pEntityScriptDefModule->getName(), "Controller");
	sourcefileBody_ += "namespace KBEngine\n{\n";
	sourcefileBody_ += "\tusing UnityEngine;\n";
	...
	if (!pEntityScriptDefModule->isComponentModule())
	{
		sourcefileBody_ += fmt::format("\tpublic class {}Base : uFrame.MVVM.Controller\n\t{{\n", newModuleName);
		sourcefileBody_ += fmt::format("\t\tprivate uFrame.MVVM.ViewModels.IViewModelManager<{}ViewModel> _{}ViewModelManager;\n\n", pEntityScriptDefModule->getName(), pEntityScriptDefModule->getName());

		sourcefileBody_ += fmt::format("\t\t[uFrame.IOC.InjectAttribute(\"{}\")]\n", pEntityScriptDefModule->getName());
		sourcefileBody_ += fmt::format("\t\tpublic uFrame.MVVM.ViewModels.IViewModelManager<{}ViewModel> {}ViewModelManager {{\n", pEntityScriptDefModule->getName(), pEntityScriptDefModule->getName());
		sourcefileBody_ += fmt::format("\t\t\tget {{ return _{}ViewModelManager; }}\n", pEntityScriptDefModule->getName());
		sourcefileBody_ += fmt::format("\t\t\tset {{ _{}ViewModelManager = value; }} }}\n\n", pEntityScriptDefModule->getName());

		sourcefileBody_ += fmt::format("\t\tpublic IEnumerable<{}ViewModel> {}ViewModels {{\n", pEntityScriptDefModule->getName(), pEntityScriptDefModule->getName());
		sourcefileBody_ += fmt::format("\t\t\tget {{ return {}ViewModelManager.ViewModels; }} }}\n\n", pEntityScriptDefModule->getName());

		sourcefileBody_ += fmt::format("\t\tpublic override void Setup() {{ base.Setup(); }}\n\n");

		sourcefileBody_ += fmt::format("\t\tpublic override void Initialize(uFrame.MVVM.ViewModels.ViewModel viewModel) {{\n");
		sourcefileBody_ += fmt::format("\t\t\tbase.Initialize(viewModel);\n");
		sourcefileBody_ += fmt::format("\t\t\tthis.Initialize{}((({}ViewModel)(viewModel))); }}\n\n", pEntityScriptDefModule->getName(), pEntityScriptDefModule->getName());

		sourcefileBody_ += fmt::format("\t\tpublic virtual {}ViewModel Create{}() {{\n", pEntityScriptDefModule->getName(), pEntityScriptDefModule->getName());
		sourcefileBody_ += fmt::format("\t\t\treturn (({}ViewModel)(this.Create(Guid.NewGuid().ToString()))); }}\n\n", pEntityScriptDefModule->getName());

		sourcefileBody_ += fmt::format("\t\tpublic override uFrame.MVVM.ViewModels.ViewModel CreateEmpty() {{\n");
		sourcefileBody_ += fmt::format("\t\t\treturn new {}ViewModel(this.EventAggregator); }}\n\n", pEntityScriptDefModule->getName());

		sourcefileBody_ += fmt::format("\t\tpublic virtual void Initialize{}({}ViewModel viewModel) {{\n", pEntityScriptDefModule->getName(), pEntityScriptDefModule->getName());
		sourcefileBody_ += fmt::format("\t\t\t{}ViewModelManager.Add(viewModel); }}\n\n", pEntityScriptDefModule->getName());

		sourcefileBody_ += fmt::format("\t\tpublic override void DisposingViewModel(uFrame.MVVM.ViewModels.ViewModel viewModel) {{\n");
		sourcefileBody_ += fmt::format("\t\t\tbase.DisposingViewModel(viewModel);\n");
		sourcefileBody_ += fmt::format("\t\t\t{}ViewModelManager.Remove(viewModel); }}\n\n", pEntityScriptDefModule->getName());
	}
	return true;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityModuleModelBegin(ScriptDefModule* pEntityScriptDefModule)
{
	std::string newModuleName = fmt::format("{}{}", pEntityScriptDefModule->getName(), "ViewModel");
	sourcefileBody_ += "namespace KBEngine\n{\n";
	sourcefileBody_ += "\tusing UnityEngine;\n";
	sourcefileBody_ += "\tusing System;\n";
	sourcefileBody_ += "\tusing System.Collections;\n";
	...
	if (!pEntityScriptDefModule->isComponentModule())
	{
		sourcefileBody_ += fmt::format("\tpublic partial class {} : {}Base\n\t{{\n", newModuleName, pEntityScriptDefModule->getName());
	}
	return true;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityModuleViewBegin(ScriptDefModule* pEntityScriptDefModule)
{
	std::string newModuleName = fmt::format("{}{}", pEntityScriptDefModule->getName(), "View");
	sourcefileBody_ += "namespace KBEngine\n{\n";
	sourcefileBody_ += "\tusing UnityEngine;\n";
	sourcefileBody_ += "\tusing System;\n";
	sourcefileBody_ += "\tusing System.Collections;\n";
	...
	{
		sourcefileBody_ += fmt::format("\tpublic class {} : {}Base\n\t{{\n", newModuleName, newModuleName);
		sourcefileBody_ += fmt::format("\t\tprotected override void InitializeViewModel(uFrame.MVVM.ViewModels.ViewModel model) {{\n");
		sourcefileBody_ += fmt::format("\t\t\tbase.InitializeViewModel(model);\n");
		sourcefileBody_ += fmt::format("\t\t\t// NOTE: this method is only invoked if the 'Initialize ViewModel' is checked in the inspector.\n");
		sourcefileBody_ += fmt::format("\t\t\t// var vm = model as {}ViewModel;\n", pEntityScriptDefModule->getName());
		sourcefileBody_ += fmt::format("\t\t\t// This method is invoked when applying the data from the inspector to the viewmodel.  Add any view-specific customizations here.\n");
		sourcefileBody_ += fmt::format("\t\t}}\n\n");

		sourcefileBody_ += fmt::format("\t\tpublic override void Bind() {{\n");
		sourcefileBody_ += fmt::format("\t\t\tbase.Bind();\n");
		sourcefileBody_ += fmt::format("\t\t\t// Use this.{} to access the viewmodel.\n", pEntityScriptDefModule->getName());
		sourcefileBody_ += fmt::format("\t\t\t// Use this method to subscribe to the view-model.\n");
		sourcefileBody_ += fmt::format("\t\t\t// Any designer bindings are created in the base implementation.\n");
		sourcefileBody_ += fmt::format("\t\t}}\n\n");
	}
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityModuleViewBaseBegin(ScriptDefModule* pEntityScriptDefModule)
{
	std::string newModuleName = fmt::format("{}{}", pEntityScriptDefModule->getName(), "ViewBase");
	sourcefileBody_ += "namespace KBEngine\n{\n";
	sourcefileBody_ += "\tusing UnityEngine;\n";
	sourcefileBody_ += "\tusing System;\n";
	sourcefileBody_ += "\tusing System.Collections;\n";
	...
	sourcefileBody_ += "\tusing uFrame.MVVM.Bindings;\n";
	sourcefileBody_ += "\tusing uFrame.MVVM.ViewModels;\n";
	sourcefileBody_ += "\tusing uFrame.MVVM.Views;\n";
	sourcefileBody_ += "\tusing UniRx;\n\n";
	if (!pEntityScriptDefModule->isComponentModule())
	{
		sourcefileBody_ += fmt::format("\tpublic class {} : uFrame.MVVM.Views.ViewBase\n\t{{\n", newModuleName);
		...
		for (; propIter != clientPropertys.end(); ++propIter)
		{
			...
			sourcefileBody_ += fmt::format("\t\t[UnityEngine.HideInInspector()]\n");
			sourcefileBody_ += fmt::format("\t\tpublic bool _Bind{} = true;\n\n", pPropertyDescription->getName());

			sourcefileBody_ += fmt::format("\t\t[uFrame.MVVM.Attributes.UFGroup(\"{}\")]\n", pPropertyDescription->getName());
			sourcefileBody_ += fmt::format("\t\t[UnityEngine.SerializeField()]\n");
			sourcefileBody_ += fmt::format("\t\t[UnityEngine.HideInInspector()]\n");
			sourcefileBody_ += fmt::format("\t\t[UnityEngine.Serialization.FormerlySerializedAsAttribute(\"_{}onlyWhenChanged\")]\n", pPropertyDescription->getName());
			sourcefileBody_ += fmt::format("\t\tprotected bool _{}OnlyWhenChanged;\n\n\n", pPropertyDescription->getName());
		}
		...
		sourcefileBody_ += "\t\tpublic override string DefaultIdentifier { get { return base.DefaultIdentifier; } }\n";
		sourcefileBody_ += "\t\tpublic override System.Type ViewModelType { get { return typeof(" + std::string(pEntityScriptDefModule->getName()) +"ViewModel); } }\n";
		sourcefileBody_ += "\t\tpublic " + std::string(pEntityScriptDefModule->getName()) + "ViewModel " + std::string(pEntityScriptDefModule->getName()) + " { get { return (" + std::string(pEntityScriptDefModule->getName()) +"ViewModel)ViewModelObject; } }\n\n";
		
		sourcefileBody_ += "\t\tpublic override void Bind() {\n\t\t\tbase.Bind();\n";
		propIter = clientPropertys.begin();
		for (; propIter != clientPropertys.end(); ++propIter)
		{
			PropertyDescription* pPropertyDescription = propIter->second;
			sourcefileBody_ += fmt::format("\t\t\tif (_Bind{}) {} this.BindProperty(this.{}.{}Property, this.{}Changed, _{}OnlyWhenChanged); {}\n", pPropertyDescription->getName(), "{", pEntityScriptDefModule->getName(), pPropertyDescription->getName(), pPropertyDescription->getName(), pPropertyDescription->getName(), "}");
		}
		methodIter = clientMethods.begin();
		for (; methodIter != clientMethods.end(); ++methodIter)
		{
			MethodDescription* pMethodDescription = methodIter->second;
			sourcefileBody_ += fmt::format("\t\t\tif (_Bind{}) {} this.BindCommandExecuted(this.{}.{}Command, this.{}Executed); {}\n", pMethodDescription->getName(), "{ ", pEntityScriptDefModule->getName(), pMethodDescription->getName(), pMethodDescription->getName(), " }\n");
		}
		sourcefileBody_ += "\t\t}\n\n";
		...
		{
			MethodDescription* pMethodDescription = methodIter->second;
			sourcefileBody_ += fmt::format("\t\tpublic virtual void {}Executed({}{}Command command) {{  }}\n", pMethodDescription->getName(), pEntityScriptDefModule->getName(), pMethodDescription->getName());
		}
	}
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityModuleBegin(ScriptDefModule* pEntityScriptDefModule)
{
	...
	else
	{
		...
		//sourcefileBody_ += fmt::format("\t\tpublic {}(uFrame.Kernel.IEventAggregator aggregator) :base(aggregator) {{}}\n\n", newModuleName);//uFrame_kbe
	}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityModuleViewModelEnd(ScriptDefModule* pEntityScriptDefModule)
{
	sourcefileBody_ += fmt::format("\t}}\n\tpublic partial class {}ViewModel: {}Base {{ public {}ViewModel(uFrame.Kernel.IEventAggregator aggregator):base(aggregator) {{  }} }}\n}}", pEntityScriptDefModule->getName(), pEntityScriptDefModule->getName(), pEntityScriptDefModule->getName());
	return true;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityModuleEnd(ScriptDefModule* pEntityScriptDefModule)
{
	sourcefileBody_ += "\t}\n}";
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::getArrayType(DataType* pDataType, std::string& outstr)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProcessMessagesMethod(ScriptDefModule* pEntityScriptDefModule)
{
	std::string ownstr = "";
	if (pEntityScriptDefModule->isComponentModule())
		ownstr = "owner.";
	...
	if (!pEntityScriptDefModule->isComponentModule())
	{
		sourcefileBody_ += fmt::format("\n\t\tpublic {}(uFrame.Kernel.IEventAggregator aggregator) :base(aggregator) \n\t\t{{\n", newModuleName);
		ScriptDefModule::PROPERTYDESCRIPTION_MAP clientPropertys = pEntityScriptDefModule->getClientPropertyDescriptions();
		ScriptDefModule::PROPERTYDESCRIPTION_MAP::const_iterator propIter = clientPropertys.begin();
		for (; propIter != clientPropertys.end(); ++propIter)
		{
		...
		{
			MethodDescription* pMethodDescription = methodIter->second;
			sourcefileBody_ += fmt::format("\t\t\t_{}Command = new Signal<{}{}Command>(this);\n", pMethodDescription->getName(), pEntityScriptDefModule->getName(), pMethodDescription->getName());
		}
	...
	sourcefileBody_ += fmt::format("\t\t\tScriptModule sm = EntityDef.moduledefs[\"{}ViewModel\"];\n\n", pEntityScriptDefModule->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityPropertyComponent(ScriptDefModule* pEntityScriptDefModule,
...
static std::string propertyFormat(std::string sourcefileBody_, std::string pName, std::string pType, const char* defaultValStr)
{
	sourcefileBody_ += fmt::format("\n\t\tprivate P<{}> _{}Property = new P<{}>();\n", pType, pName, pType);
	sourcefileBody_ += fmt::format("\t\tpublic virtual P<{}> {}Property {}{}{}{}{}", pType, pName, "{ get { return _", pName, "Property; } set { _", pName, "Property = value; } }\n");
	sourcefileBody_ += fmt::format("\t\tpublic virtual {} {} {}{}{}{}{}", pType, pName, "{ get { return ", pName, "Property.Value; } set { ", pName, "Property.Value = value; } }\n");
	sourcefileBody_ += fmt::format("\t\t//tpublic {} {} = {};\n", pType, pName, (strlen(defaultValStr) > 0 ? defaultValStr : "0"));
	return sourcefileBody_;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_INT8(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{

	sourcefileBody_ = propertyFormat(sourcefileBody_, pPropertyDescription->getName(), "SByte", pPropertyDescription->getDefaultValStr());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_INT16(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ = propertyFormat(sourcefileBody_, pPropertyDescription->getName(), "Int16", pPropertyDescription->getDefaultValStr());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_INT32(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ = propertyFormat(sourcefileBody_, pPropertyDescription->getName(), "Int32", pPropertyDescription->getDefaultValStr());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_INT64(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ = propertyFormat(sourcefileBody_, pPropertyDescription->getName(), "Int64", pPropertyDescription->getDefaultValStr());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_UINT8(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ = propertyFormat(sourcefileBody_, pPropertyDescription->getName(), "Byte", pPropertyDescription->getDefaultValStr());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_UINT16(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ = propertyFormat(sourcefileBody_, pPropertyDescription->getName(), "UInt16", pPropertyDescription->getDefaultValStr());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_UINT32(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ = propertyFormat(sourcefileBody_, pPropertyDescription->getName(), "UInt32", pPropertyDescription->getDefaultValStr());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_UINT64(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ = propertyFormat(sourcefileBody_, pPropertyDescription->getName(), "UInt64", pPropertyDescription->getDefaultValStr());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_FLOAT(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ = propertyFormat(sourcefileBody_, pPropertyDescription->getName(), "float", pPropertyDescription->getDefaultValStr());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_DOUBLE(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ = propertyFormat(sourcefileBody_, pPropertyDescription->getName(), "double", pPropertyDescription->getDefaultValStr());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_STRING(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ = propertyFormat(sourcefileBody_, pPropertyDescription->getName(), "string", pPropertyDescription->getDefaultValStr());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_UNICODE(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ = propertyFormat(sourcefileBody_, pPropertyDescription->getName(), "string", pPropertyDescription->getDefaultValStr());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_PYTHON(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	ERROR_MSG("ClientSDKUFrame::writeEntityProperty_PYTHON(): nonsupport!\n");
	return false;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_PY_DICT(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	ERROR_MSG("ClientSDKUFrame::writeEntityProperty_PY_DICT(): nonsupport!\n");
	return false;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_PY_TUPLE(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	ERROR_MSG("ClientSDKUFrame::writeEntityProperty_PY_TUPLE(): nonsupport!\n");
	return false;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_PY_LIST(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	ERROR_MSG("ClientSDKUFrame::writeEntityProperty_PY_LIST(): nonsupport!\n");
	return false;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_BLOB(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	sourcefileBody_ = propertyFormat(sourcefileBody_, pPropertyDescription->getName(), "byte[]", pPropertyDescription->getDefaultValStr());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_ARRAY(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_VECTOR2(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
#ifdef CLIENT_NO_FLOAT
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_VECTOR3(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
#ifdef CLIENT_NO_FLOAT
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityProperty_VECTOR4(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
#ifdef CLIENT_NO_FLOAT
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityMethod(ScriptDefModule* pEntityScriptDefModule,
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityMethodArgs_ARRAY(FixedArrayType* pFixedArrayType, std::string& stackArgsTypeBody, const std::string& childItemName)
{
	// ��������������Ҫ����������ֱ������������
	if (childItemName.size() == 0 || childItemName[0] == '_')
	{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUFrame::writeEntityMethodArgs_Const_Ref(DataType* pDataType, std::string& stackArgsTypeBody)
{
	return true;
}
