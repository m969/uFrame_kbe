...
#ifndef KBE_CLIENT_SDK_UFRAME_H
#define KBE_CLIENT_SDK_UFRAME_H
...
class ClientSDKUFrame : public ClientSDK
{
public:
	ClientSDKUFrame();
	virtual ~ClientSDKUFrame();
	...
	virtual bool writeEntityModuleControllerBegin(ScriptDefModule * pEntityScriptDefModule);
	virtual bool writeEntityModuleControllerBaseBegin(ScriptDefModule * pEntityScriptDefModule);
	virtual bool writeEntityModuleModelBegin(ScriptDefModule * pEntityScriptDefModule);
	virtual bool writeEntityModuleViewBegin(ScriptDefModule * pEntityScriptDefModule);
	virtual bool writeEntityModuleViewBaseBegin(ScriptDefModule * pEntityScriptDefModule);
	virtual bool writeEntityModuleBegin(ScriptDefModule* pEntityScriptDefModule);
	virtual bool writeEntityModuleViewModelEnd(ScriptDefModule * pEntityScriptDefModule);
