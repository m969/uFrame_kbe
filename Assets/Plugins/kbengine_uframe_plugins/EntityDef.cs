...
namespace KBEngine
{
	...
	public class EntityDef
	{
		...
		{
			ScriptModule pAvatarModule = new ScriptModule("AvatarViewModel");
			EntityDef.moduledefs["AvatarViewModel"] = pAvatarModule;
			...
			List<DATATYPE_BASE> pAvatar_CreateCellClient_args = new List<DATATYPE_BASE>();
			pAvatar_CreateCellClient_args.Add(EntityDef.id2datatypes[13]);
			pAvatar_CreateCellClient_args.Add(EntityDef.id2datatypes[8]);

			Method pAvatar_CreateCellClient = new Method();
			pAvatar_CreateCellClient.name = "CreateCellClient";
			pAvatar_CreateCellClient.methodUtype = 2;
			pAvatar_CreateCellClient.aliasID = 1;
			pAvatar_CreateCellClient.args = pAvatar_CreateCellClient_args;

			pAvatarModule.methods["CreateCellClient"] = pAvatar_CreateCellClient; 
			pAvatarModule.useMethodDescrAlias = true;
			pAvatarModule.idmethods[(UInt16)pAvatar_CreateCellClient.aliasID] = pAvatar_CreateCellClient;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(CreateCellClient / 2).");

			ScriptModule pFoodModule = new ScriptModule("FoodViewModel");
			EntityDef.moduledefs["FoodViewModel"] = pFoodModule;
			...
			List<DATATYPE_BASE> pFood_CreateCellClient_args = new List<DATATYPE_BASE>();
			pFood_CreateCellClient_args.Add(EntityDef.id2datatypes[13]);
			pFood_CreateCellClient_args.Add(EntityDef.id2datatypes[8]);

			Method pFood_CreateCellClient = new Method();
			pFood_CreateCellClient.name = "CreateCellClient";
			pFood_CreateCellClient.methodUtype = 13;
			pFood_CreateCellClient.aliasID = 1;
			pFood_CreateCellClient.args = pFood_CreateCellClient_args;

			pFoodModule.methods["CreateCellClient"] = pFood_CreateCellClient; 
			pFoodModule.useMethodDescrAlias = true;
			pFoodModule.idmethods[(UInt16)pFood_CreateCellClient.aliasID] = pFood_CreateCellClient;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Food), method(CreateCellClient / 13).");

			ScriptModule pSmashModule = new ScriptModule("SmashViewModel");
			EntityDef.moduledefs["SmashViewModel"] = pSmashModule;
			...
			List<DATATYPE_BASE> pSmash_CreateCellClient_args = new List<DATATYPE_BASE>();
			pSmash_CreateCellClient_args.Add(EntityDef.id2datatypes[13]);
			pSmash_CreateCellClient_args.Add(EntityDef.id2datatypes[8]);

			Method pSmash_CreateCellClient = new Method();
			pSmash_CreateCellClient.name = "CreateCellClient";
			pSmash_CreateCellClient.methodUtype = 14;
			pSmash_CreateCellClient.aliasID = 1;
			pSmash_CreateCellClient.args = pSmash_CreateCellClient_args;

			pSmashModule.methods["CreateCellClient"] = pSmash_CreateCellClient; 
			pSmashModule.useMethodDescrAlias = true;
			pSmashModule.idmethods[(UInt16)pSmash_CreateCellClient.aliasID] = pSmash_CreateCellClient;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Smash), method(CreateCellClient / 14).");
