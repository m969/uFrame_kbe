namespace KBEngine
{
	...
	*/
	public class KBEngineApp
	{
		...
		public string serverProtocolMD5 = "04A903A469CD4E33787C2F577AAB527E";
		public string serverEntitydefMD5 = "A9183D5ACBC29CA06D827F71DC2E7960";
		...
		*/
		public void Client_onCreatedProxies(UInt64 rndUUID, Int32 eid, string entityType)
		{
			...
			var entityType_ViewModel = entityType + "ViewModel";//uFrame_kbe
			
			if(!this.entities.ContainsKey(eid))
			{
				ScriptModule module = null;
				if(!EntityDef.moduledefs.TryGetValue(entityType_ViewModel, out module))//uFrame_kbe
				{
                ...
                //uFrame_kbe
                var controller = uFrame.Kernel.uFrameKernel.Container.Resolve(typeof(uFrame.MVVM.Controller), entity_type + "Controller") as uFrame.MVVM.Controller;
                Entity entity = controller.Create();
                //
				entity.id = eid;
