...
namespace uFrame.Kernel
{
    public class uFrameKernel : MonoBehaviour
    {
        ...
        private static clientapp _kbeClientapp;//uFrame_kbe
        ...
        public static clientapp KbeClientapp//uFrame_kbe
        {
            get { return _kbeClientapp ?? (_kbeClientapp = FindObjectOfType<clientapp>()); }
